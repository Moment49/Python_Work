...
# filename = 'python_work/text_files/guests.txt'



# active = True
# prompt = "Enter 'q' or 'Q' to exit\n"
...
#         break
#     else:
#         print(f'Welcome {username} as a cybersecurity software developer')
...
#             break
#         else:
#             users_info[username] = user_response
#             with open(filename, 'a') as file_obj:
#                 file_obj.write(f"\n{user_response}")
